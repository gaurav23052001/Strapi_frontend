...
const Checkout = ({ cart }) => {
  ...
  return (
  <div>
    <Script type="application/javascript" src={`https://securegw.paytm.in/merchantpgpui/checkoutjs/merchants/${env(MID)}.js`} onload="onScriptLoad();" crossorigin="anonymous"></Script>
<Script>
      ...
      <div className="container px-5 py-24 mx-auto min-h-screen">
        <div className="flex flex-col w-full mb-12">
          ...
          <ul className='list-decimal px-8'>
            ...
            {cart.map((item) => {
              console.log("hiiiii",item.attributes)
