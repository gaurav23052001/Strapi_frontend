...
export default function Home() {
  return (
    ...
    <div className='h-[80vh] rem object-cover overflow-hidden object-center '>
      <img object-none object-left-top bg-yellow-300 w-24 h-24  src="istockphoto1.jpg" alt="" />
    </div>
  ...
  <div className="container px-5 py-24 mx-auto">
    ...
    <button className="flex mx-auto mt-16 text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">Start Shoping</button>
  </div>
</section>
  )
}
