  ...
  <div className="container px-5 py-24 mx-auto">
    <div className="lg:w-4/5 mx-auto flex flex-wrap">
      ...
      <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        ...
        <h1 className="text-gray-900 text-3xl title-font font-medium mb-1"> {product[0]['attributes']['Tittle']}</h1>
        ...
        <p className="leading-relaxed">{product[0]['attributes']['Discripation']}</p>
