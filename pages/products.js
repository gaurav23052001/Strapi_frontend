...
const products = (props) => {
  ...
  <div className="container px-5 py-24 mx-auto">
    <div className="flex flex-wrap w-full mb-20">
      <div className="lg:w-1/2 w-full mb-6 lg:mb-0">
        <h1 className="sm:text-3xl text-2xl font-medium title-font mb-2 text-gray-900">My shop </h1>
  ...
  src={item.attributes.Image.data && item.attributes.Image.data.attributes && item.attributes.Image.data.attributes.name} alt="content"/>
